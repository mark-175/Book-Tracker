...
{
    public Task<List<BookSearchResult>> FindBookInDb(string query, List<string> preferredLanguages);
    public Task<Book> AddBookToDb(Book book);
    public Task<Book> FindOrCreateManualBook(AddManualBookDTO dto);
